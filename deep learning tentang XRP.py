...
# Pengumpulan Data: Mengambil data harga XRP dari Yahoo Finance.
# 
...
data = yf.download('XRP-USD', start='2023-01-04', end='2025-01-01')
...
plt.title('Harga XRP Prediksi vs Aktual')
plt.xlabel('Tanggal')
